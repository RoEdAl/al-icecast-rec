...
readonly -a ARECORD_PARAMS=(-q -M -N -t raw -D ${AUDIO_DEVICE:-hw:} -c 2 -r ${AUDIO_SAMPLE_RATE:-48000} -f ${ARECORD_FORMAT:-S16_LE})
readonly -a FFMPEG_PRE=(-hide_banner -loglevel repeat+error -f ${FFMPEG_FORMAT:-s16le} -ac 2 -ar ${AUDIO_SAMPLE_RATE:-48000} -i -)
